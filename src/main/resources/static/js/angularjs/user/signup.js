...
app.controller('signupCtrl', function ($scope, $http) {
    ...
    $scope.signup = function () {
        ...
        if (!emailPattern.test($scope.signupRequest.email)) {
            showStickyNotification('Please enter a valid email address.', 'danger', 3000);
            return;
        }
        ...
        $scope.signupDTO = angular.copy($scope.signupRequest);

        $http.post(url, $scope.signupDTO)
